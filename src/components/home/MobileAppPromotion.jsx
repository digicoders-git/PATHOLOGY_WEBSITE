        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-[40%] flex justify-center items-center mb-8 lg:mb-0">
            <motion.div
              ...
              className="w-[170px] sm:w-[200px] lg:w-[215px] aspect-[9/19.5] bg-white rounded-[36px] border-[8px] border-black shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center p-6 relative"
            >
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <motion.p
              ...
              className="text-gray-500 text-sm mb-8 max-w-md mx-auto lg:mx-0"
            >
